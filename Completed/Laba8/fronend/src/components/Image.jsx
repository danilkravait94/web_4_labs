...
function Image() {
    ...
    return (
        <div>
            ...
            <div>
                <button id="add" className="links" onClick={add}>Додати</button>
                <button id="delete" className="links" onClick={remove}>Видалити</button>
                <button id="increace" className="links" onClick={increase}>Збільшити</button>
                <button id="decreace" className="links" onClick={decrease}>Зменшити</button>
            </div>
        </div>
    )
}
